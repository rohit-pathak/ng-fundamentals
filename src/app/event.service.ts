...
const EVENTS = [
  ...
  { id: 4, name: 'UN Angular Summit', imageUrl: '/assets/images/basic-shiled.png', date: '6/10/2037', time: '8am', location: { address: 'The UN Angular Center', city: 'New York', country: 'USA' } },
];
