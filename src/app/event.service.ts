...
const EVENTS = [
  ...
  {
    id: 2, name: 'ng-nl', price: 699, imageUrl: '/assets/images/ng-nl.png', date: '4/15/2037', time: '9am', location: { address: '127 DT ', city: 'Amsterdam', country: 'NL' },
    sessions: [{ "id": 0, "name": "consectetur ut", "presenter": "Rosetta Rowland", "duration": 1, "level": "intermediate", "abstract": "Officia Lorem ex nisi occaecat aliquip quis irure elit fugiat in duis. Aliqua commodo esse ipsum culpa ad proident duis consequat Lorem cupidatat aliquip Lorem voluptate elit. Est nostrud pariatur exercitation cillum. Excepteur irure ad ea aliquip eu dolor cupidatat ipsum eu. Tempor anim nulla nostrud ut cillum ad ex commodo labore dolor ea deserunt sunt.", "voters": [] }, { "id": 1, "name": "eu consequat", "presenter": "Salazar Hahn", "duration": 2, "level": "intermediate", "abstract": "Ipsum ex non voluptate aliqua qui tempor nisi cillum anim aute voluptate duis duis anim. Nisi minim aliquip nostrud quis et. Pariatur amet non amet enim quis quis exercitation id aliqua elit reprehenderit. Eu fugiat officia dolor ut exercitation deserunt id. Sint esse quis labore officia laborum irure sit tempor cillum eiusmod pariatur deserunt tempor. Aliquip eiusmod enim est exercitation est culpa.", "voters": [] }, { "id": 2, "name": "cupidatat ipsum", "presenter": "Watkins Hinton", "duration": 3, "level": "beginner", "abstract": "Do mollit nisi culpa et non laborum nostrud voluptate dolore adipisicing. Culpa ea anim reprehenderit elit aute eu magna. Voluptate reprehenderit ipsum sunt esse est nisi ipsum consequat.", "voters": [] }]
  },
  {
